...
const packages = [['block-picker', 'blockscene'], ['image-optimization', 'image-pipeline']].map(([dir, slug]) => resolve(`../strapi-plugin-${dir}/artifacts/aduptive-strapi-${slug}-${version}.tgz`))
